...
export const metadata: Metadata = {
	...
	openGraph: {
	  title: "Hour Zero - Because Every Mark Counts",
	  description: "HourZero is your one-stop platform to get study resources of GGSIPU! 🚀 Access organized notes, past papers, assignments, and lab files without the hassle.",
	  url: BASE_URL,
	  siteName: "Hour Zero",
	  type: "website"
	}
