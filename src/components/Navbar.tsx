...
const Navbar = () => {
  ...
  return (
    <nav className='flex items-center justify-between bg-gradient-to-r from-black via-purple-900 to-black text-white px-6 py-4 font-work-sans'>
    <div className='flex items-center gap-6 px-2 '>
      ...
      <Link href={"/"} className='hover:text-purple-200 transition-colors text-6xl '>
        Home
      </Link>
