        ...
        <div className="relative flex  h-full flex-col justify-between gap-6 overflow-hidden rounded-xl border-0.75 p-6  dark:shadow-[0px_0px_27px_0px_#2D2D2D] md:p-6">
          <div className="relative flex flex-1 flex-col justify-between gap-3">
            <div className="space-y-3">
              ...
              <br/>
              <p className="text-white text-center">We have the exact resources - notes, playlists and survival kits that will actually get you a good GPA—without you having to pull a miracle.
              <br/> <br/>So go ahead, procrastinate a little longer (or maybe not). We’ve got your back. 😎</p>
            </div>
          </div>
        </div>
      </div>
