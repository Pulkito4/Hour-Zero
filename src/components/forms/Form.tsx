    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (!title || !file) {
            toast({
                variant: "destructive",
                title: "Error",
                description: "Please fill all required fields and attach a PDF file.",
                duration: 10000,
            });
    ...
    return (
        ...
        >
            ...
            <div className="mb-4">
                ...
                <FileUploader fieldChange={handleFileChange} fileUrl={fileUrl} />
            </div>
            ...
            <button
                ...
                className={`w-full py-2 px-4 rounded transition-all duration-200 flex items-center justify-center gap-2 ${
                    isSubmitting ? "bg-black cursor-not-allowed" : "bg-purple-600 hover:bg-purple-700"
                }`}
            >
                {isSubmitting ? (
